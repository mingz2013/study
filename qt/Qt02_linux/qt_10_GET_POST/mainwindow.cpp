...
void MainWindow::on_pushButton_2_clicked()
{
    ...
    cookie.setValue("305603665");
    QList<QNetworkCookie> list;
    list.append(cookie);
    QVariant var;
    var.setValue(list);
    QUrl url("https://ssl.ptlogin2.qq.com/check?uin=305603665&appid=1003903&js_ver=10036&js_type=0&login_sig=JUC4UNyS3Wp9UNN9x1NYFENqynWvoZ5pdGeYyBhmJtw6Ptt4xxz4B*tBP51j1W12&u1=http%3A%2F%2Fweb2.qq.com%2Floginproxy.html&r=0.5420278559534947");
    http->sendRequest(url,var );
}

void MainWindow::on_pushButton_3_clicked()
{
    QUrl url("https://passport.baidu.com/v2/api/?logincheck&token=db0cb29888b0aabbd04b853e3ca67baa&tpl=pcs&apiver=v3&tt=1375165779529&username=305603665%40qq.com&isphone=false&callback=bd__cbs__p13ax4");
